-- Update Usage RPC to Use Server-Side Pro Verification
-- This prevents clients from spoofing Pro status
--
-- BREAKING CHANGE: Now checks user_entitlements table instead of trusting p_is_pro
-- Client p_is_pro is used as HINT only when no server record exists (migration period)
