...
Define the operating model for keeping ProsePal and any other apps under the
same legal owner operationally separate.

This is about clean infrastructure boundaries, low cross-app contamination, and
maintainable administration. It is not a legal-separation document and contains
no credentials or private recovery details.
