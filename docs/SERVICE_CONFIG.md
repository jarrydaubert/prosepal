...
| Local side-by-side staging | `com.prosepal.prosepal.staging` | `ProsePal Staging` | can install beside production | tracked staging target/scheme plus ignored local Run env values |
