# Historical: ProsePal Native 2026 Technical Direction

> Frozen context. This document records the direction that shaped the native
> rewrite. Current architecture and launch scope live in
> [Native architecture](../../engineering/architecture.md) and
> [V1 launch contract](../../product/v1-launch-contract.md).
...
Open work belongs in [`docs/BACKLOG.md`](../../BACKLOG.md). This document
defines historical direction; it is not a progress tracker.
