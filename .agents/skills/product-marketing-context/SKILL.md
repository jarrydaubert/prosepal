...
description: "When the user wants to create or update their product marketing context document. Also use when the user mentions 'product context,' 'marketing context,' 'set up context,' 'positioning,' or wants to avoid repeating foundational information across marketing tasks. Creates `.Codex/product-marketing-context.md` that other marketing skills reference."
metadata:
  version: 1.0.0
---
...
The document is stored at `.Codex/product-marketing-context.md`.

## Workflow

### Step 1: Check for Existing Context

First, check if `.Codex/product-marketing-context.md` already exists.
...
After gathering information, create `.Codex/product-marketing-context.md` with this structure:
...
- Save to `.Codex/product-marketing-context.md`
